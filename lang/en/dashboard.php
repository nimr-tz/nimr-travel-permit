...
return [
    ...
    'supervisor_not_needed' => 'No supervisor review required',
    'supervisor_not_needed_hint_named' => 'Your role is already at supervisor level. Requests go straight to :name, :title.',
    'supervisor_not_needed_hint_named_plain' => 'Your role is already at supervisor level. Requests go straight to the :name.',
    'supervisor_not_needed_hint' => 'Your role is already at supervisor level. Requests go straight to the next approver in your unit hierarchy.',
