...
return [
    ...
    'supervisor_not_needed' => 'Hakuna mapitio ya msimamizi yanayohitajika',
    'supervisor_not_needed_hint_named' => 'Nafasi yako tayari iko ngazi ya usimamizi. Maombi yako huenda moja kwa moja kwa :name, :title.',
    'supervisor_not_needed_hint_named_plain' => 'Nafasi yako tayari iko ngazi ya usimamizi. Maombi yako huenda moja kwa moja kwa :name.',
    'supervisor_not_needed_hint' => 'Nafasi yako tayari iko ngazi ya usimamizi. Maombi yako huenda moja kwa moja kwa mwidhinishaji anayefuata katika muundo wa kitengo chako.',
