<x-guest-layout>
    ...
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-slate-900 tracking-tight">{{ __('Confirm your password') }}</h2>
        <p class="text-sm text-slate-500 mt-1">{{ __('This is a secure area. Please confirm your password to continue.') }}</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative" x-data="{ show: false }">
                ...
                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 flex items-center pr-3.5 text-slate-400 hover:text-slate-600 transition">
