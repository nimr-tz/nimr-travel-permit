...
Route::middleware(['auth', 'verified', PreventBackHistory::class])->group(function () {
    ...
    Route::get('/travel-reports', TravelReportsController::class)->name('travel-reports.index');
    ...
    Route::get('/travel-requests/{travelRequest}/invitation', [TravelRequestController::class, 'downloadInvitation'])->name('travel-requests.invitation.download');
    ...
    Route::patch('/travel-requests/{travelRequest}/report/unlock', [TravelRequestController::class, 'unlockReport'])->name('travel-requests.report.unlock');
